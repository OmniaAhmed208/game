...
@php
  // $allPosts = App\Models\publishPost::where('creator_id', Auth::user()->id)->count();
  // $appCount = App\Models\Api::distinct()->where('creator_id', Auth::user()->id)->count('account_type');
  ...
  $lastPosts = App\Models\publishPost::where('scheduledTime', '>=', $startDate)->where('status', 'published')
