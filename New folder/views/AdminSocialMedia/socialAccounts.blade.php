                  ...
                  <div class="col-md-3 col-sm-6 col-12">
                      <div class="info-box user-info py-3">
                        <div class="info-box-icon w-100 flex-column position-relative">
                          ...
                          <span class="rounded position-absolute ml-5 {{ $account['account_type'] }}App" style="background: transparent">
                            <i class="fab fa-{{ $account['account_type'] }} rounded"></i>
                          </span>
                            ...
                            <ul class="list-unstyled m-0">
                              <li class="my-2 py-1 rounded" style="background-color: #E6F8FE"> 
                                @if ($account['account_type'] === 'youtube' || 'twitter')
                                  <a href = "{{ route($account['account_type'],$account['account_id']) }}" class="text-dark px-2"> View posts </a> 
                                @else                                    
