...
@section('content')
  ...
  @php
    $Allpost = App\Models\PublishPost::all()->where('creator_id', Auth::user()->id);
    $published_post = App\Models\PublishPost::all()->where('status', 'published')->where('creator_id', Auth::user()->id);
    $scheduled_post = App\Models\PublishPost::all()->where('status', 'pending')->where('creator_id', Auth::user()->id);
