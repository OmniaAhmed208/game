                ...
                <div class="card p-3">
                    ...
                    <form class="form-horizontal" action="{{ url('storePosts')}}" method="post" enctype="multipart/form-data">
                        ...
                        <section class="socialAccounts pl-3">
                            ...
                            <textarea cols="30" rows="15" maxlength="5000" class="form-control mt-3" name="postData" placeholder="Whta's on your mind?" style="resize: none"></textarea>
                            <div class="container">
                            ...
                            <div class="form-group container" id="youtubeSelectBlock" style="display: none;">
                                <div class="row">
                                    ...
                                    <div class="col-10 mb-3">
                                        <input type="text" class="form-control" name="videoTitle" id="videoTitle" placeholder="Enter video title for youtube">
                                    </div>
...
<script>
    ...
    {       
        ...
        var userAccounts = <?php echo $userAccounts;?>;
