...
@if(session()->has('channelConnect'))
  <script> toastr.error('{{ session('channelConnect') }}'); </script>
@endif

@if(session()->has('accountDeleted'))
  <script> toastr.success('{{ session('accountDeleted') }}'); </script>
@endif

@if(session()->has('timeUpdated'))
  <script> toastr.success("{{ session('timeUpdated') }}"); </script>
@endif

{{-- when add id and secret in services page --}}
@if (session()->has('settingsApi'))
  <script> toastr.success("{{ session('settingsApi') }}"); </script>
@endif
...
@if (session()->has('youtube_category'))
  <script> toastr.success("{{ session('youtube_category') }}"); </script>
@endif
