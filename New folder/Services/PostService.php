...
class PostService {
    ...
    // public function storPost($request)
    // {
    //     try{
    ...
    //         $result = [
    //             'data' => $data, // The data you want to return
    //             'messages' => $messages, // The messages you want to return
    //         ];
    ...
    // public function update($request, $postId = null)
    // {
    //     try {
    //         // Check if an existing post ID is provided for update
    //         if ($postId !== null) {
    ...
    //             // You can return a success response or updated post details
    //             return response()->json([
